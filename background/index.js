  ...
  (() => {
    ...
    const load = (() => {
      ...
      chrome.webRequest.onCompleted.addListener(
        (details) =>
          Background.setRequest(details.requestId, { success: true }),
        urlFilter
      );

      chrome.webRequest.onErrorOccurred.addListener(
        (details) =>
          Background.setRequest(details.requestId, { success: false }),
        urlFilter
      );
...
/* eslint-disable no-undef */
const Graph = __nccwpck_require__(968);
...
var Iterator = __nccwpck_require__(446);
var take = __nccwpck_require__(233);
var chain = __nccwpck_require__(673);
 ...
 */
var Iterator = __nccwpck_require__(446);
var support = __nccwpck_require__(465);
 ...
 * into an array.
 */
var iter = __nccwpck_require__(522);
...
(() => {
const Calculator = __nccwpck_require__(864)();
const Requests = __nccwpck_require__(250)(Calculator);
__nccwpck_require__(680)(Requests);
