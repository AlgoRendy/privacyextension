        ...
        {Object.keys(linkColor).map((x, i) => (
          <ListItem dense key={i}>
            <ListItemIcon>
              <Checkbox
                edge="start"
                checked={filter.type[x]}
                onChange={() => dispatch(filterActions["type_" + x]())}
              />
            </ListItemIcon>
            <ListItemText primary={x} />
            <ListItemSecondaryAction>
              <LinearScaleIcon style={{ color: settings.linkColors[x] }} />
            </ListItemSecondaryAction>
          </ListItem>
        ))}
      </Collapse>
        ...
        {methods.map((x, i) => (
          <ListItem dense key={i}>
            <ListItemIcon>
              <Checkbox
                edge="start"
                checked={filter.method[x]}
                onChange={() => dispatch(filterActions["method_" + x]())}
              />
            </ListItemIcon>
            <ListItemText primary={x} />
          </ListItem>
